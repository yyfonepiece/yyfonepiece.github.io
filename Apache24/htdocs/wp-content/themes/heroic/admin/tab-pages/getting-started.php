...
<div id="getting_started" class="heroic-tab-pane active">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="heroic-info-title text-center"><?php echo __('About the Heroic theme','heroic'); ?><?php if( !empty($quality['Version']) ): ?> <sup id="heroic-theme-version"><?php echo esc_attr( $quality['Version'] ); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="heroic-tab-pane-half heroic-tab-pane-first-half">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/admin/img/heroic.png'; ?>" alt="<?php esc_html_e( 'Quality Theme', 'heroic' ); ?>" />
				</div>
			</div>	
		</div>
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="heroic-tab-pane-half heroic-tab-pane-first-half">
					...
					<a href="<?php echo esc_url('https://demo.webriti.com/?theme=Heroic'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-desktop info-icon"></div>
					<p class="info-text"><?php echo __('Lite Demo','heroic'); ?></p></a>
					...
					<p class="info-text"><?php echo __('PRO Demo','heroic'); ?></p></a>
			...
			<div class="col-md-6">	
				...
				<div class="heroic-tab-pane-half heroic-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Your feedback is valuable to us','heroic'); ?></p></a>
					...
					<p class="info-text"><?php echo __('Premium Theme Support','heroic'); ?></p></a>
				</div>
			</div>
			...
			<div class="col-md-6">	
				...
				<div class="heroic-tab-pane-half heroic-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Premium Theme Details','heroic'); ?></p></a>
