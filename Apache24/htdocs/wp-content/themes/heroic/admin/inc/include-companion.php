...
$hide_install = get_option('heroic_hide_customizer_companion_notice', false);
	...
	if (class_exists('WP_Customize_Section') && !class_exists('Heroic_Companion_Installer_Section')) {
		...
		class Heroic_Companion_Installer_Section extends WP_Customize_Section {
			...
			public static function enqueue() {
				...
				wp_enqueue_script('heroic-companion-install', HEROIC_ADMIN_URI . '/assets/js/plugin-install.js', array('jquery'));
				...
				<li id="accordion-section-<?php echo esc_attr($this->id); ?>" class="<?php echo esc_attr($classes); ?>">
					...
					<?php 
					 ...
					 ?>
						...
						<a class="webriti-plugin-install install-now button-secondary button" data-slug="webriti-companion" href="<?php echo esc_url_raw($plugin_install_url); ?>" aria-label="<?php esc_attr_e('Install Webriti Companion Now', 'heroic');?>" data-name="<?php esc_attr_e('Webriti Companion', 'heroic'); ?>">
					...
					<?php else: ?>
						...
						<a class="webriti-plugin-activate activate-now button-primary button" data-slug="webriti-companion" href="<?php echo esc_url_raw($plugin_activate_link); ?>" aria-label="<?php esc_attr_e('Activate Webriti Companion now', 'heroic');?>" data-name="<?php esc_attr_e('Webriti Companion', 'heroic'); ?>">
