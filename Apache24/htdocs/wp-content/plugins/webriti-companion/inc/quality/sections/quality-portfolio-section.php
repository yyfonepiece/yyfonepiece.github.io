		...
		<div class="row p-left-right-0">
					...
					<div class="col">	
						<article class="post" id="quality_project_one">
							...
							<?php } ?>
							</figcaption><a href="<?php echo $current_theme_content['project_one_thumb']; ?>" data-lightbox="image"><i class="fa fa-search "></i></a>
						</article>
					</div>
					...
					<div class="col">	
						<article class="post" id="quality_project_two">
							...
							<?php } ?>
							</figcaption><a href="<?php echo $current_theme_content['project_two_thumb']; ?>" data-lightbox="image"><i class="fa fa-search "></i></a>
						</article>
					</div>
					...
					<div class="col">	
						<article class="post" id="quality_project_three">
							...
							<?php } ?>
							</figcaption><a href="<?php echo $current_theme_content['project_three_thumb']; ?>" data-lightbox="image"><i class="fa fa-search "></i></a>
						</article>
					</div>
					...
					<div class="col">	
						<article class="post" id="quality_project_four">
							...
							<?php ?>
							</figcaption><a href="<?php echo $current_theme_content['project_four_thumb']; ?>" data-lightbox="image"><i class="fa fa-search "></i></a>
						</article>
					</div>
					...
					<div class="col">	
						<article class="post" id="quality_project_five">
							...
							<?php } ?>
							</figcaption><a href="<?php echo $current_theme_content['project_five_thumb']; ?>" data-lightbox="image"><i class="fa fa-search "></i></a>
						</article>
					</div>	
					</div>
		</div>
