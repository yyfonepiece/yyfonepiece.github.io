...
//Home project Section
    ...
    array(
        'default' => __('Spasalon Our Product Range','webriti-companion'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
		)
	...
	//Project one image
	$wp_customize->add_setting( 'spa_theme_options[product_one_thumb]',array('default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project1.jpg',
	'type' => 'option','sanitize_callback' => 'esc_url_raw',));
 
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize,
			'spa_theme_options[product_one_thumb]',
			array(
	...
	'spa_theme_options[product_one_title]', array(
        'default'        => __('Make-up Products','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	$wp_customize->add_setting(
	'spa_theme_options[product_one_desc]', array(
        'default'        => 'Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.',
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	//Project two image
	$wp_customize->add_setting( 'spa_theme_options[product_two_thumb]',array('default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project2.jpg','type' => 'option','sanitize_callback' => 'esc_url_raw',));	
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize,
			'spa_theme_options[product_two_thumb]',
			array(
				'label' => __('Image','spasalon'),
	...
	//Project Two Title
	$wp_customize->add_setting(
	'spa_theme_options[product_two_title]', array(
        'default'        => __('Golden Cream','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	$wp_customize->add_setting(
	'spa_theme_options[product_two_desc]', array(
        'default'        => 'Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.',
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	...
	//Project three image
	$wp_customize->add_setting( 'spa_theme_options[product_three_thumb]',array('default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project3.jpg','type' => 'option','sanitize_callback' => 'esc_url_raw',));
 
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize,
			'spa_theme_options[product_three_thumb]',
			array(
				'label' => __('Image','spasalon'),
	...
	//Project Three Title
	$wp_customize->add_setting(
	'spa_theme_options[product_three_title]', array(
        'default'        => __('Facial Toner','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	$wp_customize->add_setting(
	'spa_theme_options[product_three_desc]', array(
        'default'        => 'Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.',
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	...
	//Project Four image
	$wp_customize->add_setting( 'spa_theme_options[product_four_thumb]',array('default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project4.jpg','type' => 'option','sanitize_callback' => 'esc_url_raw',));
 
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize,
			'spa_theme_options[product_four_thumb]',
			array(
				'label' => __('Image','spasalon'),
				'section' => 'example_section_one',
	 ...
	 //Project Four Title
	$wp_customize->add_setting(
	'spa_theme_options[product_four_title]', array(
        'default'        => __('Premium Cleanser','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	$wp_customize->add_setting(
	'spa_theme_options[product_four_desc]', array(
        'default'        => 'Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.',
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	...
	//Project five image
	$wp_customize->add_setting( 'spa_theme_options[product_five_thumb]',array('default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project5.jpg','type' => 'option','sanitize_callback' => 'esc_url_raw',));
 
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize,
			'spa_theme_options[product_five_thumb]',
			array(
				'label' => __('Image','spasalon'),
	...
	//Project five Title
	$wp_customize->add_setting(
	'spa_theme_options[product_five_title]', array(
        'default'        => __('Silver Cleanser','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
	...
	$wp_customize->add_setting(
	'spa_theme_options[product_five_desc]', array(
        'default'        => 'Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.',
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
